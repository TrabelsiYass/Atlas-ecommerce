...
require('actions/post/authoraction.php');
              ...
              <div class="col-lg-5 position-relative bg-cover px-0" style="background-image: url('../assets/img/examples/blog2.jpg')" loading="lazy">
                <div class="z-index-2 text-center d-flex h-100 w-100 d-flex m-auto justify-content-center">
                  ...
                  <div class="p-5 ps-sm-8 position-relative text-start my-auto z-index-2"id="about">
                    ...
                    <p class="text-white opacity-8 mb-4">A team of six ambitious university students, We made it easier for you to shop from home</p>
                    <div class="d-flex p-2 text-white">
                      <div>
                        <i class="fas fa-phone text-sm"></i>
                      </div>
                      <div class="ps-3">
                        <span class="text-sm opacity-8">(+216) 71 856 992</span>
                      </div>
                    </div>
                    <div class="d-flex p-2 text-white">
                      <div>
                    ...
                    <div class="d-flex p-2 text-white">
                      ...
                      <div class="ps-3">
                        <span class="text-sm opacity-8">FSB Bizerte</span>
                      </div>
                    </div>
                    <div class="mt-4">
                    ...
                    <div class="row">
                      <div class="col-md-12 pe-2 mb-3">
                        <div class="input-group input-group-static mb-4">
                          ...
                          <input type="text" class="form-control" placeholder="Full Name" name="Myname">
                        </div>
                      </div>
                      <div class="col-md-12 pe-2 mb-3">
                        <div class="input-group input-group-static mb-4">
                          <label>I'm looking for</label>
                          <input type="text" class="form-control" placeholder="What you love" name="desire">
                        </div>
                      </div>
                      <div class="col-md-12 pe-2 mb-3">
                        <div class="input-group input-group-static mb-4">
                          <label>Your message</label>
                          <textarea name="message" class="form-control" rows="6" placeholder="I want to say that..."></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6 text-end ms-auto">
                        <button type="submit" name="Submited" >Send Message</button>
                      </div>
                    </div>
                  </div>
                </form>
