        ...
        <div class="col">
          <div class="card box-shadow-xl overflow-hidden mb-5">
            <div class="row">
              ...
              <img class="img-fluid border-radius-lg" src="uploads/<?php echo $postphoto; ?>"  loading="lazy">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12 pe-2 mb-3">
                        <div class="input-group input-group-static mb-4">
                          ...
                          <input type="text" class="form-control" name="subject" placeholder="<?php echo $postsubject;?>">
                        </div>
                      </div>
                      <div class="col-md-12 pe-2 mb-3">
                        <div class="input-group input-group-static mb-4">
                          <label>New message</label>
                          <textarea name="message" class="form-control" name="message" id="message" rows="6" ><?php echo $postmessage ; ?></textarea>
                        </div>
                      </div>
                      <div class="col-md-12 pe-2 mb-3">
                        <div class="input-group input-group-static mb-4">
                          <label>New Price</label>
                          <input type="text" class="form-control" name="price" placeholder="<?php echo $postprice;?> ">
                        </div>
                    </div>
                    <div class="row">
