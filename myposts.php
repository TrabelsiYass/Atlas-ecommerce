        ...
        <?php  while($post=$getallpost->fetch()){ ?>
          ...
          <div class="card-body card bg-gradient-dark">
            ...
            <div class="d-block text-end me-4 ">
                    <a  href="editpost.php?id=<?= $post['post_id']; ?>"  class="btn btn-sm btn-outline-white text-nowrap  w-20 mb-0">EDIT</a>
                    <a  onclick="return confirm('delete?')"href="actions/post/deletepostaction.php?id=<?= $post['post_id']; ?>" class="btn  btn-sm btn-outline-white  text-nowrap mb-0">DElETE</a>
...
$check= $bdd->query('SELECT * from posts');
