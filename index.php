...
<div class="   mx-auto">
        ...
        <h2 class="  animate__animated animate__wobble  mb-3"> <?php  if(isset($check4)) {echo  $check4;}else{echo $check1;}; ?> Articles for sale</h2> </div>
      ...
      <di class="rotating-card-container">
        ...
        <div class="card">
          <div class="card-header p-0  mt-n4 position-relative z-index-2">
              <img src="uploads/<?= $post['photo'] ?>" class="img-fluid shadow mx-auto">
          </div></div>
          </div>
